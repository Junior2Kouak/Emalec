...
Partial Class frmListeChantierArch
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmListeChantierArch))
        ...
        Me.GVListeChantierArch = New DevExpress.XtraGrid.Views.Grid.GridView()
        ...
        CType(Me.GVListeChantierArch, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.GColArchNPAVTH.DisplayFormat.FormatString = "N1"
        Me.GColArchNPAVTH.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        ...
        Me.GrpActions.Controls.Add(Me.BtnPlanningChantier)
        Me.GrpActions.Controls.Add(Me.BtnChantierDoc)
        Me.GrpActions.Controls.Add(Me.btnRestaurer)
        Me.GrpActions.Controls.Add(Me.btnAnalyse)
        ...
        'GVListeChantierArch
        '
        Me.GVListeChantierArch.Appearance.FocusedCell.BackColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(192, Byte), Integer), CType(CType(192, Byte), Integer))
        Me.GVListeChantierArch.Appearance.FocusedCell.Options.UseBackColor = True
        Me.GVListeChantierArch.Appearance.FocusedRow.BackColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(192, Byte), Integer), CType(CType(192, Byte), Integer))
        Me.GVListeChantierArch.Appearance.FocusedRow.Options.UseBackColor = True
        Me.GVListeChantierArch.Appearance.FooterPanel.Font = CType(resources.GetObject("GVListeChantierArch.Appearance.FooterPanel.Font"), System.Drawing.Font)
        Me.GVListeChantierArch.Appearance.FooterPanel.Options.UseFont = True
        Me.GVListeChantierArch.Appearance.GroupRow.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(192, Byte), Integer), CType(CType(128, Byte), Integer))
        Me.GVListeChantierArch.Appearance.GroupRow.ForeColor = System.Drawing.Color.Red
        Me.GVListeChantierArch.Appearance.GroupRow.Options.UseBackColor = True
        Me.GVListeChantierArch.Appearance.GroupRow.Options.UseForeColor = True
        Me.GVListeChantierArch.Appearance.HeaderPanel.Font = CType(resources.GetObject("GVListeChantierArch.Appearance.HeaderPanel.Font"), System.Drawing.Font)
        Me.GVListeChantierArch.Appearance.HeaderPanel.Options.UseFont = True
        Me.GVListeChantierArch.Appearance.HeaderPanel.Options.UseTextOptions = True
        Me.GVListeChantierArch.Appearance.HeaderPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.GVListeChantierArch.Appearance.HeaderPanel.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.GVListeChantierArch.Appearance.HideSelectionRow.BackColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(192, Byte), Integer), CType(CType(192, Byte), Integer))
        Me.GVListeChantierArch.Appearance.HideSelectionRow.Options.UseBackColor = True
        Me.GVListeChantierArch.Appearance.SelectedRow.BackColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(192, Byte), Integer), CType(CType(192, Byte), Integer))
        Me.GVListeChantierArch.Appearance.SelectedRow.Options.UseBackColor = True
        Me.GVListeChantierArch.AppearancePrint.Row.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(128, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.GVListeChantierArch.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GColArchNIDCHIF, Me.GColArchVCLINOM, Me.GColArchVLIBCHIF, Me.GColArchDDAT, Me.GColArchNPVHT, Me.GColArchVCANLIB, Me.GColArchDDATCRE, Me.GColArchCHAF, Me.GColArchNPAVTH, Me.GColArchNIDCHANTIER, Me.GColArchVGROUPLIB, Me.GColArchRES, Me.GColArchNBDOC})
        Me.GVListeChantierArch.GridControl = Me.GrdListeArch
        Me.GVListeChantierArch.GroupCount = 1
        resources.ApplyResources(Me.GVListeChantierArch, "GVListeChantierArch")
        Me.GVListeChantierArch.Name = "GVListeChantierArch"
        Me.GVListeChantierArch.OptionsBehavior.AutoExpandAllGroups = True
        Me.GVListeChantierArch.OptionsBehavior.Editable = False
        Me.GVListeChantierArch.OptionsBehavior.ReadOnly = True
        Me.GVListeChantierArch.OptionsDetail.EnableDetailToolTip = True
        Me.GVListeChantierArch.OptionsDetail.ShowDetailTabs = False
        Me.GVListeChantierArch.OptionsDetail.SmartDetailExpandButtonMode = DevExpress.XtraGrid.Views.Grid.DetailExpandButtonMode.CheckDefaultDetail
        Me.GVListeChantierArch.OptionsPrint.PrintGroupFooter = False
        Me.GVListeChantierArch.OptionsPrint.PrintHorzLines = False
        Me.GVListeChantierArch.OptionsView.ShowAutoFilterRow = True
        Me.GVListeChantierArch.OptionsView.ShowFooter = True
        Me.GVListeChantierArch.OptionsView.ShowGroupPanel = False
        Me.GVListeChantierArch.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() {New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.GColArchVGROUPLIB, DevExpress.Data.ColumnSortOrder.Ascending)})
        '
        'GColArchNIDCHIF
        '
        ...
        Me.GrdListeArch.MainView = Me.GVListeChantierArch
        Me.GrdListeArch.Name = "GrdListeArch"
        Me.GrdListeArch.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GVListeChantierArch})
        '
        'GrpTypeAffichage
        '
        ...
        Me.Name = "frmListeChantierArch"
        Me.WindowState = System.Windows.Forms.FormWindowState.Maximized
        Me.GrpActions.ResumeLayout(False)
        CType(Me.GVListeChantierArch, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private WithEvents GVListeChantierArch As DevExpress.XtraGrid.Views.Grid.GridView
