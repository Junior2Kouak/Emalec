...
Partial Class frmDetailStatFOU
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmDetailStatFOU))
        ...
        Me.Colancienprix = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.Colnewprix = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.Coldelta = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.Colnbcontrat = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.GVFORMATION.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.ColNFORMNUM, Me.ColVPERNOM, Me.ColVFORLIB, Me.Colancienprix, Me.Colnewprix, Me.Coldelta, Me.Colnbcontrat, Me.Colunite, Me.ColSum})
        ...
        Me.ColVPERNOM.FieldName = "VFOUMAT"
        ...
        Me.ColVPERNOM.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(CType(resources.GetObject("ColVPERNOM.Summary"), DevExpress.Data.SummaryItemType))})
        '
        'ColVFORLIB
        '
        resources.ApplyResources(Me.ColVFORLIB, "ColVFORLIB")
        Me.ColVFORLIB.FieldName = "VSTFGRPNOM"
        ...
        'Colancienprix
        '
        resources.ApplyResources(Me.Colancienprix, "Colancienprix")
        Me.Colancienprix.FieldName = "PRIXOLD"
        Me.Colancienprix.Name = "Colancienprix"
        Me.Colancienprix.OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        '
        'Colnewprix
        '
        resources.ApplyResources(Me.Colnewprix, "Colnewprix")
        Me.Colnewprix.FieldName = "PRIXNEW"
        Me.Colnewprix.Name = "Colnewprix"
        Me.Colnewprix.OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        '
        'Coldelta
        '
        Me.Coldelta.AppearanceCell.FontSizeDelta = CType(resources.GetObject("Coldelta.AppearanceCell.FontSizeDelta"), Integer)
        Me.Coldelta.AppearanceCell.FontStyleDelta = CType(resources.GetObject("Coldelta.AppearanceCell.FontStyleDelta"), System.Drawing.FontStyle)
        Me.Coldelta.AppearanceCell.GradientMode = CType(resources.GetObject("Coldelta.AppearanceCell.GradientMode"), System.Drawing.Drawing2D.LinearGradientMode)
        Me.Coldelta.AppearanceCell.Image = CType(resources.GetObject("Coldelta.AppearanceCell.Image"), System.Drawing.Image)
        Me.Coldelta.AppearanceCell.Options.UseTextOptions = True
        Me.Coldelta.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        resources.ApplyResources(Me.Coldelta, "Coldelta")
        Me.Coldelta.FieldName = "DELTA"
        Me.Coldelta.Name = "Coldelta"
        Me.Coldelta.OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        '
        'Colnbcontrat
        '
        Me.Colnbcontrat.AppearanceCell.FontSizeDelta = CType(resources.GetObject("Colnbcontrat.AppearanceCell.FontSizeDelta"), Integer)
        Me.Colnbcontrat.AppearanceCell.FontStyleDelta = CType(resources.GetObject("Colnbcontrat.AppearanceCell.FontStyleDelta"), System.Drawing.FontStyle)
        Me.Colnbcontrat.AppearanceCell.GradientMode = CType(resources.GetObject("Colnbcontrat.AppearanceCell.GradientMode"), System.Drawing.Drawing2D.LinearGradientMode)
        Me.Colnbcontrat.AppearanceCell.Image = CType(resources.GetObject("Colnbcontrat.AppearanceCell.Image"), System.Drawing.Image)
        Me.Colnbcontrat.AppearanceCell.Options.UseTextOptions = True
        Me.Colnbcontrat.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.Colnbcontrat.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        resources.ApplyResources(Me.Colnbcontrat, "Colnbcontrat")
        Me.Colnbcontrat.FieldName = "NB"
        Me.Colnbcontrat.Name = "Colnbcontrat"
        Me.Colnbcontrat.OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        '
        'Colunite
        '
        resources.ApplyResources(Me.Colunite, "Colunite")
        Me.Colunite.FieldName = "FPUNITE"
        Me.Colunite.Name = "Colunite"
        '
        'ColSum
        '
        resources.ApplyResources(Me.ColSum, "ColSum")
        Me.ColSum.FieldName = "TOTAL"
    ...
    Private WithEvents Colancienprix As DevExpress.XtraGrid.Columns.GridColumn
    Private WithEvents Colnewprix As DevExpress.XtraGrid.Columns.GridColumn
    Private WithEvents Coldelta As DevExpress.XtraGrid.Columns.GridColumn
    Private WithEvents Colnbcontrat As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Private WithEvents Colunite As DevExpress.XtraGrid.Columns.GridColumn
