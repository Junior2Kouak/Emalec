...
Public Class XR_Page_Chap_StatBySecteur

  Dim _oRapport_Fm_Imp As CRapportFM
  Dim _NomServerSQL As String

  Public Sub New(ByVal c_Rapport_Fm_Imp As CRapportFM, ByVal c_NomServerSQL As String, ByVal p_NORDER As Int32, Optional ByVal P_WithPREV As Boolean = True)

    ' Cet appel est requis par le concepteur.
    InitializeComponent()

    'Init
    Dim oTrad As New Class_Trad_Report("XR_Page_Chap_StatBySecteur")
    ...
    P_WITH_PREV.Value = P_WithPREV

    'set traduction
    oTrad.SetTraductionOnReport(Me, _oRapport_Fm_Imp.sLangue)

    'on mets à jours les expressions :
    XrLblTitre_ChapStatBySecteur.Text = p_NORDER.ToString & " - " & XrLblTitre_ChapStatBySecteur.Text
