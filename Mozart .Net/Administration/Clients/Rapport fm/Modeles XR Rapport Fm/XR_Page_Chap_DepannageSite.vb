...
Public Class XR_Page_Chap_DepannageSite
  ...
  Public Sub New(ByVal c_Rapport_Fm_Imp As CRapportFM, ByVal c_NomServerSQL As String, ByVal p_NORDER As Int32)
    ...
    'Init
    Dim oTrad As New Class_Trad_Report("XR_Page_Chap_DepannageSite")
    ...
    XrLblTitreDevisAttenteDec.Text = p_NORDER.ToString & " - " & XrLblTitreDevisAttenteDec.Text

  End Sub

  Private Sub SDS_Chap_Devis_ConfigureDataConnection(sender As Object, e As ConfigureDataConnectionEventArgs) Handles SDS_Chap_DepannageSite.ConfigureDataConnection
