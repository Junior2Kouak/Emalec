...
Public Class XR_Page_Chap_StatByPresta
  ...
  Public Sub New(ByVal c_Rapport_Fm_Imp As CRapportFM, ByVal c_NomServerSQL As String, ByVal p_NORDER As Int32, Optional ByVal c_WITH_PREV As Boolean = True)
    ...
    'Init
    Dim oTrad As New Class_Trad_Report("XR_Page_Chap_StatByPresta")
    ...
    XrLblTitre_ChapStatByPresta.Text = p_NORDER.ToString & " - " & XrLblTitre_ChapStatByPresta.Text
