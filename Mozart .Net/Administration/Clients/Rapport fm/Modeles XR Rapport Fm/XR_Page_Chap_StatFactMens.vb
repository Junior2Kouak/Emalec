...
Public Class XR_Page_Chap_StatFactMens
  ...
  Public Sub New(ByVal c_Rapport_Fm_Imp As CRapportFM, ByVal c_NomServerSQL As String, ByVal p_NORDER As Int32)
    ...
    'Init
    Dim oTrad As New Class_Trad_Report("XR_Page_Chap_StatFactMens")
    ...
    XrLblTitre_ChapStatFactMens.Text = p_NORDER.ToString & " - " & XrLblTitre_ChapStatFactMens.Text
    ...
    If XrChart35.Titles.Count > 0 Then XrChart35.Titles(0).Text = _sNameLastMonth & " " & CDate(P_DATE_FIN_LASTMONTH.Value).Year
