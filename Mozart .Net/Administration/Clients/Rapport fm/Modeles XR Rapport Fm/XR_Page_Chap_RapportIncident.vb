...
Public Class XR_Page_Chap_RapportIncident
  ...
  Public Sub New(ByVal c_Rapport_Fm_Imp As CRapportFM, ByVal c_NomServerSQL As String, ByVal p_NORDER As Int32)
    ...
    'Init
    Dim oTrad As New Class_Trad_Report("XR_Page_Chap_RapportIncident")
    ...
    XrLblTitreRapportIncident.Text = p_NORDER.ToString & " - " & XrLblTitreRapportIncident.Text

    XrChart2.Titles(0).Text = _sNameLastMonth & " " & CDate(P_DATE_FIN_LASTMONTH.Value).Year
    XrChart3.Titles(0).Text = XrChart3.Titles(0).Text & " " & CDate(P_DATE_DEBUT_ANNEE.Value).ToShortDateString
