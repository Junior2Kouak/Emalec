...
Public Class XR_Page_Chap_Maintenance
  ...
  Public Sub New(ByVal c_Rapport_Fm_Imp As CRapportFM, ByVal c_NomServerSQL As String, ByVal p_NORDER As Int32, Optional ByVal p_Periode As Int32 = 0)
    ...
    'Init
    Dim oTrad As New Class_Trad_Report("XR_Page_Chap_Maintenance")
    ...
    Select Case p_Periode
      ...
      Case 1
        ...
        P_DATE_FIN_LASTMONTH.Value = _oRapport_Fm_Imp.sDateFin_This 'DateAdd(DateInterval.Day, -DatePart(DateInterval.Day, _oRapport_Fm_Imp.sDateFin_This), _oRapport_Fm_Imp.sDateFin_This)
        P_DATE_DEBUT_LASTMONTH.Value = _oRapport_Fm_Imp.sDateDebut_This 'DateAdd(DateInterval.Day, -DatePart(DateInterval.Day, P_DATE_FIN_LASTMONTH.Value), P_DATE_FIN_LASTMONTH.Value).AddDays(1)

        P_DATE_DEBUT_ANNEE.Value = CDate("01/01/" & _oRapport_Fm_Imp.sDateFin_This.Year.ToString)

        P_DATE_FIN_12M.Value = DateAdd(DateInterval.Day, -DatePart(DateInterval.Day, _oRapport_Fm_Imp.sDateFin_This), _oRapport_Fm_Imp.sDateFin_This)
        P_DATE_DEBUT_12M.Value = DateAdd(DateInterval.Month, -12, P_DATE_FIN_12M.Value)
    ...
    XrLblMaintenanceTitle.Text = p_NORDER.ToString & " - " & XrLblMaintenanceTitle.Text
  ...
  End Sub
  Private Sub SDS_CHap_Maintenance_ConfigureDataConnection(sender As Object, e As ConfigureDataConnectionEventArgs) Handles SDS_CHap_Maintenance.ConfigureDataConnection
