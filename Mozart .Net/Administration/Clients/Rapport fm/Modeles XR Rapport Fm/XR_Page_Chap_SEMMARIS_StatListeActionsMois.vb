...
Public Class XR_Page_Chap_SEMMARIS_StatListeActionsMois
  ...
  Private Sub XrPivotGrid1_FieldValueDisplayText(sender As Object, e As PivotFieldDisplayTextEventArgs)
  ...
  Private Sub XrPivotGrid2_CustomColumnWidth(sender As Object, e As PivotCustomColumnWidthEventArgs)
