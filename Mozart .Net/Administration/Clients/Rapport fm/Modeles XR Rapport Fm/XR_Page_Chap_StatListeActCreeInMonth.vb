...
Public Class XR_Page_Chap_StatListeActCreeInMonth
  ...
  Public Sub New(ByVal c_Rapport_Fm_Imp As CRapportFM, ByVal c_NomServerSQL As String, ByVal p_NORDER As Int32, Optional ByVal c_WITH_Prev As Boolean = True)
    ...
    'Init
    Dim oTrad As New Class_Trad_Report("XR_Page_Chap_StatListeActCreeInMonth")
    ...
    XrLblTitre_ChapStatListeActCreeInMonth.Text = p_NORDER.ToString & " - " & XrLblTitre_ChapStatListeActCreeInMonth.Text
