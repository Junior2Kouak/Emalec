...
Public Class XR_Page_Chap_ActionsAstreinte
  ...
  Public Sub New(ByVal c_Rapport_Fm_Imp As CRapportFM, ByVal c_NomServerSQL As String, ByVal p_NORDER As Int32)
    ...
    'Init
    Dim oTrad As New Class_Trad_Report("XR_Page_Chap_ActionsAstreinte")
    ...
    XrLblTitreListeActionsAsteinte.Text = p_NORDER.ToString & " - " & XrLblTitreListeActionsAsteinte.Text
