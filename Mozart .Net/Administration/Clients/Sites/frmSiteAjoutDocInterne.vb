Public Class frmSiteAjoutDocInterne

    Dim oDRTmpNew As DataRow 
    Dim sModeLoad As String
    Dim dtSiteDocInterneTmp As DataTable 
    Dim bModifDetect As Boolean 

    Public Sub new(ByVal c_oDTTmpNew As Datarow, Optional ByVal c_dtSiteDocInterne As Datatable = nothing)

        ' Cet appel est requis par le concepteur.
        InitializeComponent()
        
        ' Ajoutez une initialisation quelconque après l'appel InitializeComponent().
        If Not c_dtSiteDocInterne Is Nothing Then

            dtSiteDocInterneTmp = c_dtSiteDocInterne
            sModeLoad = "C"
        Else
            sModeLoad = "M"
        End If
    ...
    Private Sub frmSiteAjoutDocInterne_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmSiteAjoutDocInterne_Load( ByVal sender As System.Object,  ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub OuvertureEnCreation()
        ...
        TxtFileSrc.Text = ""
        Label3.Text = String.Format("{0}", My.Resources.Admin_frmSiteAjoutDocInterne_ajout)
        Me.Text = Label3.Text
    ...
    Private Sub BtnSave_Click( ByVal sender As System.Object,  ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        'If MessageBox.Show("Voulez-vous enregistrer ce document ?", "Confirmation enregistrement document", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = DialogResult.Yes Then
            ...
            If sModeLoad = "C" Then
                ...
                dtSiteDocInterneTmp.Rows.Add(oDRTmpNew) 
                sModeLoad = "M"
