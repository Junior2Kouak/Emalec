...
Partial Class FrmGestionDroitFournitures
    ...
    Me.BtnCopierDroit = New System.Windows.Forms.Button()
    Me.BtnDroitsParMenu = New System.Windows.Forms.Button()
    Me.BtnFermer = New System.Windows.Forms.Button()
    Me.LabelTitre = New System.Windows.Forms.Label()
    Me.Label1 = New System.Windows.Forms.Label()
    Me.TreeList_SerieFO = New DevExpress.XtraTreeList.TreeList()
    Me.TreeCol_CCFOCOD = New DevExpress.XtraTreeList.Columns.TreeListColumn()
    ...
    CType(Me.TreeList_SerieFO, System.ComponentModel.ISupportInitialize).BeginInit()
    ...
    Me.GCPersGroupe.Location = New System.Drawing.Point(130, 53)
    Me.GCPersGroupe.MainView = Me.GVPersGroupe
    Me.GCPersGroupe.Name = "GCPersGroupe"
    Me.GCPersGroupe.Size = New System.Drawing.Size(396, 887)
    ...
    Me.GVPersGroupe.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GCol_NPERNUM, Me.GCol_VPERNOM, Me.GCol_FONC, Me.GCol_VSOCIETE, Me.GCol_VPERADSI})
    ...
    'GroupBox1
    '
    Me.GroupBox1.Controls.Add(Me.BtnCopierDroit)
    Me.GroupBox1.Controls.Add(Me.BtnDroitsParMenu)
    Me.GroupBox1.Controls.Add(Me.BtnFermer)
    Me.GroupBox1.Location = New System.Drawing.Point(12, 12)
    Me.GroupBox1.Name = "GroupBox1"
    Me.GroupBox1.Size = New System.Drawing.Size(106, 857)
    Me.GroupBox1.TabIndex = 49
    Me.GroupBox1.TabStop = False
    '
    'BtnCopierDroit
    '
    Me.BtnCopierDroit.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Bold)
    Me.BtnCopierDroit.ImeMode = System.Windows.Forms.ImeMode.NoControl
    Me.BtnCopierDroit.Location = New System.Drawing.Point(6, 41)
    Me.BtnCopierDroit.Name = "BtnCopierDroit"
    Me.BtnCopierDroit.Size = New System.Drawing.Size(90, 56)
    Me.BtnCopierDroit.TabIndex = 5
    Me.BtnCopierDroit.Text = "Copier vers autre utilisateur"
    Me.BtnCopierDroit.UseVisualStyleBackColor = True
    '
    'BtnDroitsParMenu
    '
    ...
    Me.BtnDroitsParMenu.Size = New System.Drawing.Size(90, 52)
    ...
    Me.BtnFermer.Size = New System.Drawing.Size(92, 48)
    ...
    Me.LabelTitre.Location = New System.Drawing.Point(126, 11)
    ...
    Me.Label1.Text = "Liste des série de fournitures"
    '
    'TreeList_SerieFO
    '
    Me.TreeList_SerieFO.Appearance.FocusedCell.BackColor = System.Drawing.Color.SkyBlue
    Me.TreeList_SerieFO.Appearance.FocusedCell.Options.UseBackColor = True
    Me.TreeList_SerieFO.Appearance.FocusedRow.BackColor = System.Drawing.Color.SkyBlue
    Me.TreeList_SerieFO.Appearance.FocusedRow.Options.UseBackColor = True
    Me.TreeList_SerieFO.Appearance.HeaderPanel.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold)
    Me.TreeList_SerieFO.Appearance.HeaderPanel.Options.UseFont = True
    Me.TreeList_SerieFO.Appearance.HeaderPanel.Options.UseTextOptions = True
    Me.TreeList_SerieFO.Appearance.HeaderPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
    Me.TreeList_SerieFO.Appearance.HeaderPanel.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
    Me.TreeList_SerieFO.Appearance.HeaderPanel.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap
    Me.TreeList_SerieFO.Appearance.SelectedRow.BackColor = System.Drawing.Color.SkyBlue
    Me.TreeList_SerieFO.Appearance.SelectedRow.Options.UseBackColor = True
    Me.TreeList_SerieFO.ColumnPanelRowHeight = 50
    Me.TreeList_SerieFO.Columns.AddRange(New DevExpress.XtraTreeList.Columns.TreeListColumn() {Me.TreeCol_CCFOCOD, Me.TreeCol_NPERNUM_EMALEC, Me.TreeCol_CDROIT_EMALEC, Me.TreeCol_NPERNUM_EMALECBELGIQUE, Me.TreeCol_CDROIT_BELGIQUE, Me.TreeCol_NPERNUM_EMALECIDF, Me.TreeCol_CDROIT_IDF, Me.TreeCol_NPERNUM_EQUIPAGE, Me.TreeCol_CDROIT_EQUIPAGE, Me.TreeCol_NPERNUM_MAGESTIME, Me.TreeCol_CDROIT_MAGESTIME, Me.TreeCol_NPERNUM_EMALECESPAGNE, Me.TreeCol_CDROIT_EMALECESPAGNE, Me.TreeCol_NPERNUM_SCS, Me.TreeCol_CDROIT_SCS, Me.TreeCol_NPERNUM_EMALECLUXEMBOURG, Me.TreeCol_CDROIT_EMALECLUXEMBOURG, Me.TreeCol_NPERNUM_EMALECFACILITEAM, Me.TreeCol_CDROIT_EMALECFACILITEAM, Me.TreeCol_NPERNUM_EMALECSUISSE, Me.TreeCol_CDROIT_EMALECSUISSE, Me.TreeCol_NPERNUM_EMALECMPM, Me.TreeCol_CDROIT_EMALECMPM, Me.TreeCol_NPERNUM_ALC, Me.TreeCol_CDROIT_ALC, Me.TreeCol_NPERNUM_EMAFI, Me.TreeCol_CDROIT_EMAFI, Me.TreeCol_NPERNUM_DEV, Me.TreeCol_CDROIT_DEV})
    Me.TreeList_SerieFO.Cursor = System.Windows.Forms.Cursors.Default
    Me.TreeList_SerieFO.CustomizationFormBounds = New System.Drawing.Rectangle(1551, 774, 250, 200)
    Me.TreeList_SerieFO.FooterPanelHeight = 10
    Me.TreeList_SerieFO.KeyFieldName = "NMENUNUM"
    Me.TreeList_SerieFO.Location = New System.Drawing.Point(561, 53)
    Me.TreeList_SerieFO.Name = "TreeList_SerieFO"
    Me.TreeList_SerieFO.OptionsBehavior.EditorShowMode = DevExpress.XtraTreeList.TreeListEditorShowMode.MouseUp
    Me.TreeList_SerieFO.OptionsBehavior.PopulateServiceColumns = True
    Me.TreeList_SerieFO.OptionsView.ShowSummaryFooter = True
    Me.TreeList_SerieFO.ParentFieldName = "NMENUPARENT"
    Me.TreeList_SerieFO.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.RepItemChk_CDROIT})
    Me.TreeList_SerieFO.ShowButtonMode = DevExpress.XtraTreeList.ShowButtonModeEnum.ShowOnlyInEditor
    Me.TreeList_SerieFO.Size = New System.Drawing.Size(1279, 887)
    Me.TreeList_SerieFO.TabIndex = 53
    '
    'TreeCol_CCFOCOD
    '
    Me.TreeCol_CCFOCOD.AppearanceCell.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold)
    Me.TreeCol_CCFOCOD.AppearanceCell.Options.UseFont = True
    Me.TreeCol_CCFOCOD.AppearanceHeader.ForeColor = System.Drawing.Color.Black
    Me.TreeCol_CCFOCOD.AppearanceHeader.Options.UseForeColor = True
    Me.TreeCol_CCFOCOD.Caption = "Série de fournitures"
    Me.TreeCol_CCFOCOD.FieldName = "CCFOCOD"
    Me.TreeCol_CCFOCOD.Name = "TreeCol_CCFOCOD"
    Me.TreeCol_CCFOCOD.OptionsColumn.AllowEdit = False
    Me.TreeCol_CCFOCOD.OptionsColumn.AllowMove = False
    Me.TreeCol_CCFOCOD.OptionsColumn.AllowSort = False
    Me.TreeCol_CCFOCOD.OptionsColumn.ReadOnly = True
    Me.TreeCol_CCFOCOD.OptionsFilter.AutoFilterCondition = DevExpress.XtraTreeList.Columns.AutoFilterCondition.Contains
    Me.TreeCol_CCFOCOD.Visible = True
    Me.TreeCol_CCFOCOD.VisibleIndex = 0
    Me.TreeCol_CCFOCOD.Width = 180
    '
    ...
    Me.BtnCheckedAll.Location = New System.Drawing.Point(1047, 12)
    ...
    Me.BtnUnCheckedAll.Location = New System.Drawing.Point(1210, 11)
    ...
    'ChkBoxArchives
    '
    Me.ChkBoxArchives.AutoSize = True
    Me.ChkBoxArchives.Location = New System.Drawing.Point(1486, 20)
    Me.ChkBoxArchives.Name = "ChkBoxArchives"
    Me.ChkBoxArchives.Size = New System.Drawing.Size(139, 17)
    Me.ChkBoxArchives.TabIndex = 56
    Me.ChkBoxArchives.Text = "Voir les séries archivées"
    Me.ChkBoxArchives.UseVisualStyleBackColor = True
    '
    'FrmGestionDroitFournitures
    '
    ...
    Me.Controls.Add(Me.TreeList_SerieFO)
    Me.Controls.Add(Me.Label1)
    Me.Controls.Add(Me.GCPersGroupe)
    Me.Controls.Add(Me.GroupBox1)
    Me.Controls.Add(Me.LabelTitre)
    Me.Name = "FrmGestionDroitFournitures"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Gestion des droits sur les séries de fournitures"
    ...
    CType(Me.TreeList_SerieFO, System.ComponentModel.ISupportInitialize).EndInit()
  ...
  Friend WithEvents TreeList_SerieFO As DevExpress.XtraTreeList.TreeList
  Friend WithEvents TreeCol_CCFOCOD As DevExpress.XtraTreeList.Columns.TreeListColumn
  ...
  Friend WithEvents TreeCol_NPERNUM_DEV As DevExpress.XtraTreeList.Columns.TreeListColumn
    ...
    Friend WithEvents BtnCopierDroit As Button
End Class
