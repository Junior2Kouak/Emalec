...
namespace MozartCS
{
  public partial class frmGESClient : Form
  {
    ...
    private void InitFeuille()
    {
      try
      {
        ...
        string sSQL = $"[api_sp_StatistiqueCO2] '{DateEdit_Debut.Text}','{DateEdit_Fin.Text}'";
    ...
    private void InitApigrid()
    {
      ...
      try
      {
        ...
        apiGrid.AddColumn(Resources.col_Compte, "NVEHCTE", 1100, "", 2);
        apiGrid.AddColumn(Resources.col_Contrat, "VTYPECONTRAT", 1600);
        apiGrid.AddColumn("Intervenant", "VPERNOM", 1600);
        apiGrid.AddColumn("Type", "VTYPE", 1600);
        apiGrid.AddColumn(Resources.col_Pays, "VSITPAYS", 1600);
        apiGrid.AddColumn("Département", "VDEP", 1600);
