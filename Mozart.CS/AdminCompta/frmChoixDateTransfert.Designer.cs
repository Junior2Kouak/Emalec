namespace MozartCS
{
  partial class frmChoixDateTransfert
  {
    /// <summary>
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmChoixDateTransfert));
      this.Calendar1 = new System.Windows.Forms.DateTimePicker();
      this.chkPrepa = new MozartUC.apiCheckBox();
      ...
      // chkPrepa
      // 
      this.chkPrepa.BackColor = System.Drawing.Color.Wheat;
      resources.ApplyResources(this.chkPrepa, "chkPrepa");
      this.chkPrepa.HelpContextID = 0;
      this.chkPrepa.Name = "chkPrepa";
      this.chkPrepa.UseVisualStyleBackColor = false;
      // 
      // cmdFermer
      // 
      ...
      // 
      // frmChoixDateTransfert
      // 
      this.BackColor = System.Drawing.Color.Wheat;
      this.CancelButton = this.cmdFermer;
      resources.ApplyResources(this, "$this");
      this.Controls.Add(this.Calendar1);
      this.Controls.Add(this.chkPrepa);
      this.Controls.Add(this.cmdFermer);
      this.Controls.Add(this.cmdValider);
      this.Controls.Add(this.Frame1);
      this.Controls.Add(this.Label1);
      this.Name = "frmChoixDateTransfert";
      this.ShowInTaskbar = false;
      this.Load += new System.EventHandler(this.frmChoixDateTransfert_Load);
    ...
    private MozartUC.apiCheckBox chkPrepa;
