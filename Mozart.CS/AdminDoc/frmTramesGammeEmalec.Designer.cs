namespace MozartCS
{
  partial class frmTramesGammeEmalec
  {
    /// <summary>
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmTramesGammeEmalec));
      this.cmdIntegration = new MozartUC.apiButton();
      ...
      // cmdIntegration
      // 
      resources.ApplyResources(this.cmdIntegration, "cmdIntegration");
      this.cmdIntegration.HelpContextID = 697;
      this.cmdIntegration.Name = "cmdIntegration";
      this.cmdIntegration.UseVisualStyleBackColor = true;
      this.cmdIntegration.Click += new System.EventHandler(this.cmdIntegration_Click);
      // 
      // cmdModifier
      // 
      resources.ApplyResources(this.cmdModifier, "cmdModifier");
      this.cmdModifier.HelpContextID = 312;
      ...
      this.cmdNouvelle.HelpContextID = 310;
      ...
      this.cmdArch.HelpContextID = 313;
      ...
      this.cmdVisu.HelpContextID = 311;
      ...
      this.cmdListeArch.HelpContextID = 313;
      ...
      this.cmdEdit.HelpContextID = 311;
      ...
      // 
      // frmTramesGammeEmalec
      // 
      this.BackColor = System.Drawing.Color.Wheat;
      this.CancelButton = this.cmdQuitter;
      resources.ApplyResources(this, "$this");
      this.Controls.Add(this.cmdIntegration);
      ...
      this.Name = "frmTramesGammeEmalec";
      this.ShowInTaskbar = false;
      this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
      this.Load += new System.EventHandler(this.frmTramesGammeEmalec_Load);
    ...
    private MozartUC.apiButton cmdIntegration;
