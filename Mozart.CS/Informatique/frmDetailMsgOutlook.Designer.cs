namespace MozartCS
{
  partial class frmDetailMsgOutlook
	{
    /// <summary>
    ...
    {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDetailMsgOutlook));
			...
			this.fileDropTargetPanel1 = new Aspose.Email.Windows.Forms.FileDropTargetPanel();
			...
			// 
			// fileDropTargetPanel1
			// 
			this.fileDropTargetPanel1.AllowDrop = true;
			resources.ApplyResources(this.fileDropTargetPanel1, "fileDropTargetPanel1");
			this.fileDropTargetPanel1.Name = "fileDropTargetPanel1";
			this.fileDropTargetPanel1.DragDrop += new System.Windows.Forms.DragEventHandler(this.fileDropTargetPanel1_DragDrop);
			this.fileDropTargetPanel1.DragEnter += new System.Windows.Forms.DragEventHandler(this.fileDropTargetPanel1_DragEnter);
			// 
			// frmDetailMsgOutlook
			// 
			...
			this.Controls.Add(this.fileDropTargetPanel1);
    ...
    private System.Windows.Forms.OpenFileDialog CommonDialog1;
		...
		private Aspose.Email.Windows.Forms.FileDropTargetPanel fileDropTargetPanel1;
	}
}
