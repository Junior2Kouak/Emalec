namespace MozartCS
{
  partial class frmGestSecteurClient
  {
    /// <summary>
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmGestSecteurClient));
      ...
      this.apiTGrid1.InitNewRowE += new MozartUC.apiTGrid.InitNewRowEEventHandler(this.apiTGrid1_InitNewRowE);
      ...
      this.Name = "frmGestSecteurClient";
      this.Load += new System.EventHandler(this.frmGestSecteurClient_Load);
