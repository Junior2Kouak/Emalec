namespace MozartCS
{
  partial class frmListeArtReapproTech
  {
    /// <summary>
    ...
    {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmListeArtReapproTech));
			...
			this.apiGridH.RowStyle += new MozartUC.apiTGrid.RowStyleEventHandler(this.apiGridH_RowStyle);
			// 
			// cmdFind
			// 
			...
			this.Name = "frmListeArtReapproTech";
			this.ShowInTaskbar = false;
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmListeArtReapproTech_Load);
			this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.frmListeArtReapproTech_KeyUp);
