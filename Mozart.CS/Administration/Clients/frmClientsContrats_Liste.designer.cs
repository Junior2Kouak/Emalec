namespace MozartCS
{
  partial class frmClientsContrats_Liste
  {
    /// <summary>
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmClientsContrats_Liste));
      ...
      this.BtnFormuleRev = new MozartUC.apiButton();
      this.BtnVisu = new MozartUC.apiButton();
      this.SuspendLayout();
      // 
      // cmdNouvelle
      // 
      ...
      // BtnFormuleRev
      // 
      resources.ApplyResources(this.BtnFormuleRev, "BtnFormuleRev");
      this.BtnFormuleRev.HelpContextID = 721;
      this.BtnFormuleRev.Name = "BtnFormuleRev";
      this.BtnFormuleRev.Tag = "19";
      this.BtnFormuleRev.UseVisualStyleBackColor = true;
      this.BtnFormuleRev.Click += new System.EventHandler(this.BtnFormuleRev_Click);
      // 
      // BtnVisu
      // 
      resources.ApplyResources(this.BtnVisu, "BtnVisu");
      this.BtnVisu.HelpContextID = 0;
      ...
      this.Controls.Add(this.BtnFormuleRev);
    ...
    private MozartUC.apiButton BtnFormuleRev;
    private MozartUC.apiButton BtnVisu;
  }
}
