namespace MozartCS
{
  partial class frmFormulaireReservation
	{
    /// <summary>
    ...
    {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmFormulaireReservation));
			...
			this.panelRevision.Controls.Add(this.txtDetail);
			this.panelRevision.Controls.Add(this.apiLabel5);
			this.panelRevision.Controls.Add(this.txtObservations);
			this.panelRevision.Controls.Add(this.cboType);
			this.panelRevision.Controls.Add(this.apiLabel7);
			this.panelRevision.Controls.Add(this.apiLabel6);
			this.panelRevision.Controls.Add(this.cboVehicule);
			this.panelRevision.Controls.Add(this.apiLabel4);
			...
			this.txtDetail.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))));
			...
			this.apiLabel5.BackColor = System.Drawing.Color.BurlyWood;
			...
			resources.ApplyResources(this.cboVehicule, "cboVehicule");
			this.cboVehicule.Name = "cboVehicule";
			this.cboVehicule.SelectionChangeCommitted += new System.EventHandler(this.cboVehicule_SelectionChangeCommitted);
			// 
			// apiLabel4
			// 
			resources.ApplyResources(this.apiLabel4, "apiLabel4");
			this.apiLabel4.BackColor = System.Drawing.Color.BurlyWood;
			this.apiLabel4.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))));
            ...
            resources.GetString("cboStatut.Items3")});
			...
			this.txtDateDebut.Properties.CalendarTimeEditing = DevExpress.Utils.DefaultBoolean.True;
			...
			this.txtDateDebut.Properties.DisplayFormat.FormatString = "g";
			this.txtDateDebut.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
			this.txtDateDebut.Properties.EditFormat.FormatString = "g";
			this.txtDateDebut.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
			this.txtDateDebut.Properties.MaskSettings.Set("mask", "g");
			// 
			// cmdAnnulerRev
			// 
			...
			this.txtDateFin.Properties.CalendarTimeEditing = DevExpress.Utils.DefaultBoolean.True;
			...
			this.Name = "frmFormulaireReservation";
